...
{
    [Description(@"Sends a single keystroke to the selected element.  Requires an element to be selected.
This command is used to send the non-text commands.  For a full list see the Key property.")]
    public class DoSendKeyCommand : SingleSelectorCommandBase
    {
        ...
        [Description(@"The Key to send to the selected element.  This parameter is required.
